...
// NOTA: el export de contactos ya no vive acá — es el permiso
// granular `can_export_contacts` (src/lib/auth/permissions.ts,
// espejo de la migración 041), que un override por persona puede
// pisar. Los defaults del CASE reproducen el viejo admin+.
